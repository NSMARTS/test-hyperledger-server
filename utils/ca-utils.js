...
exports.buildCCP = (org) => {
  ...
  switch (org) {
    case 'naver':
      ccpPath = path.resolve(__dirname, 'connection-profile', 'connection-naver.json');
      break;
    case 'delivery':
      ccpPath = path.resolve(__dirname, 'connection-profile', 'connection-delivery.json');
      break;
    case 'restaurant':
      ccpPath = path.resolve(__dirname, 'connection-profile', 'connection-restaurant.json');
      break;
  }
